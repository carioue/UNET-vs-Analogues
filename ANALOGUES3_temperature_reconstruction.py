...
jours=[]
dates =xr.open_dataset(PATH+"/data/psl_day_MIROC6_unet_r5i1p1f1_noleapday.nc").sel(time=slice(f'{1880}-01-01',f'{2100}-12-31')).time
for i in dates:
...
data_dates= pd.read_csv(PATH+'/data/TARGETr5i1p1f1_analogues_40membres_1950_2022.csv') #load file constructed with ANALOGUES2_compare40members.py 
...
np.save(PATH+'/data/Trec_'+str(member_target)+'.npy', reconstruction)
